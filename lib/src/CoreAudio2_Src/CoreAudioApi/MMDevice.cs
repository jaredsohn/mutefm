...
namespace CoreAudioApi
{
    public class MMDevice
    {
        ...
        // look at this: http://stackoverflow.com/questions/4522808/whats-up-with-marshal-release
        public void Release()
        {
            IntPtr pointer = Marshal.GetIUnknownForObject(_RealDevice);
            Marshal.Release(pointer);
            
            GC.Collect(); // probably unnecessary here
        }
        ...
        {
            object result;
            int activateResult = _RealDevice.Activate(ref IID_IAudioSessionManager, CLSCTX.ALL, IntPtr.Zero, out result);
