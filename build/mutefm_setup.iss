...
Filename: "http://www.mutefm.com/wizard.html"; Flags: shellexec runasoriginaluser
...
//    result := result + 'If you want to use web-based music without a separate browser' + newline + newline
//end;
